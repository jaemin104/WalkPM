...
class RealRoutinePlaylistInfo extends StatefulWidget {
  final List<String> selectedSongs;

  const RealRoutinePlaylistInfo({Key? key, required this.selectedSongs})
      : super(key: key);
...
class _RoutinePlaylistInfoState extends State<RealRoutinePlaylistInfo> {
  ...
  Future<void> fetchSongDetails() async {
    ...
    for (String title in widget.selectedSongs) {
