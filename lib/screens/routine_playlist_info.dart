...
class RoutinePlaylistInfo extends StatelessWidget {
  // SpotifyRemoteService 객체 생성
  final SpotifyRemoteService spotifyService = SpotifyRemoteService(
    setStatus: (String message, {String? message}) {
